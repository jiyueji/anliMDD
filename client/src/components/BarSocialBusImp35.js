...
const BarSocialBusImp35 = observer((props) => {
  if (!props.data) {
    return false
  }
  ...
  const maxFirstAxisVal = roundClosestTop( maxNumFoa, 10000 )
...
//  const needFormatThous = !!props.formatThous
  ...
  const COLOR_SCALE = [ "#31BEF9", "#59B961" ]
  const BAR_WIDTH = 20
  ...
  return  <div className="main-block">
        ...
        <VictoryChart width={700} height={300} 
          ...
          <VictoryLegend x={165} y={270}
            ...
            data={[
              ...
              { name: `${maxYearStr} ${legendTitle}`, symbol: {type: 'minus'} }
            ]}
          />
        ...
        <label className="bot-chart-com-sm pl-3">{botComments}</label>
    </div>
})

export default BarSocialBusImp35