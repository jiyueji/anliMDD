...
const BarChartDropDrillBuy = observer((props) => {
                ...
                <div className="table-emulation-header">
                    <div className="header-column">
                        <div className="header-row">
                            ...
                            <div className="header-sorting">Recent Month Population</div>
                        </div>
                    </div>
                ...
                <div className="table-emulation">
                    <div className="table-row">
                        ...
                        <div className="table-content">
                            ...
                            <div className="table-content-title">Population</div>

                            <VictoryChart width={700} height={300} 
                              theme={hlp.smallChartTheme}
                              domainPadding={{x: [20, 0], y: 50}} 
                              padding={{left: 70, top: 25, right: 25, bottom: 80}}
                              containerComponent={
