...
const BarSocialEarnDur = observer((props) => {
...
//  const chartDataBar = chartData[dataPropName]
  ...
  const bar1 = chartData['numrc_within_data'] || [],
    bar2 = chartData['numrc_greater_data'] || []
...
//  const needFormatThous = !!props.formatThous
  ...
  const COLOR_SCALE = [ "#AF4799", "#0074C0"]
  const BAR_WIDTH = 20
...
//                  labelComponent={<TooltipEarnSegment data={chartData.tooltip_data}/>}
                ...
                <VictoryLegend x={125} y={270}
                  ...
                  data={[
                    { name: `Seniority < 12 months ${maxYearStr}`, symbol: {type: 'square'} },
                    { name: `Seniority > 12 months ${maxYearStr}`, symbol: {type: 'square'} }
                  ]}
                />
...
export default BarSocialEarnDur
