                ...
                <div style={{position:"relative"}}>
                    ...
                    {/* 弹框内容 */}
                    {
                        displayFlag ? <div className="kpiAgpDisplayFlag">
                            ...
                            <h5>Buyer Segment Definition</h5>
                    ...
                    <div style={{ marginLeft: '1%', marginRight: '1%', border: "10px solid #5198ee" }}>
                        <table width="100%" border="0" border-collapse="collapse" cellSpacing="0" cellPadding="0" style={{ textAlign: "center", fontSize: "12px", wordBreak: 'break-all' }}>
                            ...
                            <thead>
                                <tr>
                                    <th style={{ height: "40px", border: "1px solid #e5e6e9" }} className="twoSegmentLine">
                                        <div style={{ position:'absolute',top:"10px",left:"8px" }}>Segment</div>
                                        <div style={{ position:'absolute',top:"25px",left:"75px" }}>Mthly Avg</div>
                                    </th>
                                    <th style={{ height: "40px", border: "1px solid #e5e6e9" }}>Buyer Count</th>
                                    <th style={{ height: "40px", border: "1px solid #e5e6e9" }}>Productivity</th>
                                    <th style={{ height: "40px", border: "1px solid #e5e6e9" }}>Sales(% of Tlt)</th>
                                    <th style={{ height: "40px", border: "1px solid #e5e6e9" }}>YTD vs SPLY</th>
                                </tr>
                            </thead>
                            <tbody>
                                {
                                    data.map((item, index) => {
                                        return index !== 2 ? <tr key={index} style={{ fontWeight: index == 6 ? "700" : "500" }}>
                                            <td style={{ width: "140px", height: "40px", border: "1px solid #e5e6e9", fontWeight: "700", textAlign: " left", paddingLeft: "4px", lineHeight: "22px" }}>{item.segment_desc == 'Customer' ? 'Registered Customers' : item.segment_desc == 'ABO (Purchasing Only)' ? 'Customer Equivalents' : item.segment_desc}</td>
